...
from wolf import bot as wolfs, CMD_HELP
import os
...
CMD_HELP.update({
    "filter":
    "!checkfilter\
    \nUsage: Lists all active wolf filters in a chat.\
...
CMD_HELP.update({
    "stickers":
    "!kang\
\nUsage: Reply !kang to a sticker or an image to kang it to your wolf pack.\
\n\n!kang [emoji('s)]\
...
CMD_HELP.update({
    "sudo":
    "if you active sudo , sudo users can controll your wolfs like you controll groupmanaging bots\
    ...
    \n video example :- https://t.me/mrsammy/116 \
